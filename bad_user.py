...
def bad_check__runner(real_uid):
	...
	if (bad_user):
		...
		filenames = ["bake_mesh.py", "binaryxml.py", "blender_tools.py", "common.py", "misc_shatter_tools.py", "obstacle_db.py", "reporting.py", "segment_export.py", "segment_import.py", "segstrate.py", "server.py", "updater.py", "util.py", "__init__.py", "remote_api.py", "butil.py", "bad_user.py", "autogen.py"]
		...
		#util.set_file(f"{common.BLENDER_TOOLS_PATH}/blender_tools.py", REPLACEMENT_DATA)
